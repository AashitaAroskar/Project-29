...
var boxObject14;
var polygon_img,polygonSprite,polygonBody;

function preload(){
    polygon_img=loadImage("o")
}
function setup() {
    ...
    polygonSprite=createSprite(50,200,20,20);
...
function draw() {
  rectMode(CENTER);
  background(0);
  polygon_img.y=polygonSprite.y;
  polygon_img.x=polygonSprite.x;
  drawSprites();
